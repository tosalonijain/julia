...
function _rand(rng::AbstractRNG, sp::SamplerBigFloat, ::CloseOpen01{BigFloat}, ::Void)
...
rand_ui52_raw(r::AbstractRNG) = reinterpret(UInt64, rand(r, CloseOpen12()))
